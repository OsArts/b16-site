  ...
  <div id="baraban-otkatnoy" class="bg-gradient-to-r from-cyan-500 to-blue-500">
    ...
    <div id="opilki">
      ...
      <div class="pic1">
        <div class="nowrap">
          <!-- IMG 7 -->
          <img class="flex-item w80" src="../assets/img/opilki_mass.jpg" />

          <!-- IMG 8 -->
          <img class="flex-item w80" src="../assets/img/opilki_zapaika.jpg" />
        </div>
      </div>
      ...
      <ol>
        <li>
          Расход Опилок при чистке в Барабане 10% от массы изделия. Например, для чистки шубы из Норки массой 3 килограмма, понадобится примерно 300 грамм опилок (зависит от степени загрязнения). То есть Одним килограммом наших опилок Вы сможете почистить 3 такие шубы.
        </li>
